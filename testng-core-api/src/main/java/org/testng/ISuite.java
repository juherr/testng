...
public interface ISuite extends IAttributes {
  ...
  /**
   * @param parameterName The name of the parameter Returns the value of this parameter, or null if
   *     none was specified.
   */
   ...
   *
   * <p>Returns a map where the key is the group and the value is a list of methods used by this
   * group.
   */
   ...
   *
   * <p>Returns the share state of the current suite.
   */
